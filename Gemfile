...
gem 'enju_oai', '0.1.0.pre5'#:git => 'git://github.com/next-l/enju_oai.git'
gem 'enju_book_jacket', "0.1.0.pre"
gem 'enju_manifestation_viewer', '0.1.0.pre3'#:git => 'git://github.com/next-l/enju_manifestation_viewer.git'
...
gem 'state_machine'
gem 'sunspot_rails', '~> 2.0.0.pre.120925'#'~> 2.0.0.pre.120720'#'~> 2.0.0.pre.120417'
gem 'progress_bar'
gem 'friendly_id', '~> 4.0'
