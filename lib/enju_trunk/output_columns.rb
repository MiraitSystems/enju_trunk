...
book root,other_title_transcription,その他のタイトル（ヨミ）,Other title(transcription),plural,plural,manifestation,
book root,other_title_alternative,その他のタイトル（代替）,Other title(alternative),plural,plural,manifestation,
...
book,excluding_tax,受入価格(税抜),Excluding Tax,singular,singular,item,
book,tax,消費税額,Tax,singular,singular,item,
book,tax_rate,消費税区分,Tax rate,singular,singular,item,
