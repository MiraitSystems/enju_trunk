class SeriesStatementRelationshipTypesController < InheritedResources::Base
  add_breadcrumb "I18n.t('page.listing', :model => I18n.t('activerecord.models.series_statement_relationship_type'))", 'users_path', :only => :index
  add_breadcrumb "I18n.t('page.editing', :model => I18n.t('activerecord.models.series_statement_relationship_type'))", 'edit_user_path(params[:id])', :only => [:edit, :update]
